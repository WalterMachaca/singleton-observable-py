...
- Permite suscribir funciones que se ejecutan automáticamente ante cada evento (Observer). - Cada clase que hereda mantiene su propio singleton, sin mezclarse con otras. 
