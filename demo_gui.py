...
ttk.Button(tab_biblioteca, text="Agregar préstamo de prueba", bootstyle="success", command=lambda: gestor_biblioteca.registrar({"libro": "1984", "multa": 5.0}) ).pack(pady=8) 
